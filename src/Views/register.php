    ...
    <main>
        <div class="formulaire mx-auto mt-4 border p-4 rounded-4">
            ...
            <form method="POST" action="" novalidate>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Votre nom</label><span
                        class="ms-2 text-danger fst-italic fw-light"><?= $errors["username"] ?? '' ?></span>
                    <input type="text" name="username" value="<?= $_POST["username"] ?? "" ?>" class="form-control"
                        id="exampleInputEmail1" aria-describedby="emailHelp">
                </div>
                <div class="mb-3">
                    <label for="exampleInputPassword1" class="form-label">Votre prénom</label><span
                        class="ms-2 text-danger fst-italic fw-light"><?= $errors["firstname"] ?? '' ?></span>
                    <input type="text" name="firstname" value="<?= $_POST["firstname"] ?? "" ?>" class="form-control"
                ...
                <div class="mb-3">
                    <label for="inputCity" class="form-label">Entrez le mot de passe a nouveau</label><span
                        class="ms-2 text-danger fst-italic fw-light"><?= $errors["confirmPassword"] ?? '' ?></span>
                    <input type="password" name="confirmPassword" value="<?= $_POST["confirmPassword"] ?? "" ?>"
                        class="form-control" id="inputCity">
                </div>
                <div class="mb-3 form-check">
                    <input type="checkbox" name="cgu" class="form-check-input" id="exampleCheck1">
                    <label class="form-check-label" for="exampleCheck1">CGU</label><span
                        class="ms-2 text-danger fst-italic fw-light"><?= $errors["cgu"] ?? '' ?></span>
                </div>
