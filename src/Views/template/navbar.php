    ...
    <div class="container-fluid">
        <div class="collapse navbar-collapse d-flex" id="navbarScroll">
            ...
            <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                <li class="nav-item">
                    <a class="nav-link color" href="http://localhost:8000/index.php?url=01_home">Home</a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link color" href="http://localhost:8000/index.php?url=03_a_propos">A propos</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link color" href="http://localhost:8000/index.php?url=05_contact">Contact</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link color" href="http://localhost:8000/index.php?url=04_click_and_collect">Click And
                        Collect</a>
                </li>
            </ul>
            <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
                ...
                <?php endif; ?>
                <li class="nav-item">
                    <a class="nav-link" href="http://localhost:8000/index.php?url=06_profil"><i
                            class="bi bi-person-circle color"></i></a>
                </li>
                <?php if (isset($_SESSION['user']) && $_SESSION['user']['role'] === 'admin'): ?>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="http://localhost:8000/index.php?url=adminUsers">Gestion
                                    des
                ...
                <?php if (isset($_GET['url']) && $_GET['url'] === '04_click_and_collect'): ?>
                    <li>
                        <button class="btn btn-primary color" type="button" data-bs-toggle="offcanvas"
